...
/**
 * Heartbeat_Feedback_Widget to display feedback
 *
 * @author mjdbaga@gmail.com
 */
class Heartbeat_Feedback_Widget extends WP_Widget {
  ...
  function __construct() {
    $this->widget_slug = 'hb_feedback_widget';
    $this->widget_template_slug = 'widget';
    $this->widget_template_name = 'feedback';
    $this->form_template_path = HB_FEEDBACK_PLUGIN_DIR . '/templates/form-feedback.tpl.php';
    add_action( 'switch_theme', array( $this, 'flush_widget_cache' ) );
    parent::__construct(
            $this->widget_slug, // Base ID
            __( 'Feedback Widget', $this->widget_slug ), // Name
            array( 'description' => __( 'A widget to display feedback.', $this->widget_slug ), ) // Args
    );
  }
  ...
  public function parse_widget( $instance ) {
    ...
    $cache_time = HB_FEEDBACK_CACHE_TIME; 
    ...
    $html = Heartbeat_Feedback_Api::parse( $this->widget_template_slug, $this->widget_template_name, $data );
