...
class Heartbeat_Feedback_Api {
  ...
  public static function render( $slug, $name = null, $data = array(), $var_name = 'data', $echo = true ) {
    if( $echo !== true ) {
      return Heartbeat_Feedback_Common::render( $slug, $name, $data, $var_name, $echo );
    }
    Heartbeat_Feedback_Common::render( $slug, $name, $data, $var_name, $echo );
  }
  ...
  public static function parse( $slug, $name = null, $data = array(), $var_name = 'data' ) {
    return Heartbeat_Feedback_Common::render( $slug, $name, $data, $var_name, false );
  }
