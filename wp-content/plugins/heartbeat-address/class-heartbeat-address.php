...
/*
	Plugin Name: Heartbeat Address Plugin
	Description: Bespoke Plugin to show address
	Version: 1.0
...
class Heartbeat_Address
{
	 ...
	 *
	 * @return   Heartbeat_Address    A reference to an instance of this class.
	 * @since    0.1.0
	 */
	public static function get_instance() 
	{
		if( null == self::$instance ) {
			self::$instance = new Heartbeat_Address();
		}
	...
	function register_autoloader( $class ) 
	{
		...
		$file = 'class-heartbeat-address-' . implode( '-', $directories );
    ...
    {
    	register_widget( 'Heartbeat_Address_Widget' );
    }

    function init_custom_admin_settings() 
    {
		$admin_settings = Heartbeat_Address_Admin::get_instance();
    }

}

$heartbeat_address = Heartbeat_Address::get_instance();