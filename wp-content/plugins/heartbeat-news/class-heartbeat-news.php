...
/*
	Plugin Name: Heartbeat News Plugin
	Description: Bespoke Plugin to create news functionalities to display across website
	Version: 1.0
...
class Heartbeat_News
{
	 ...
	 *
	 * @return   Heartbeat_News    A reference to an instance of this class.
	 * @since    0.1.0
	 */
	public static function get_instance() 
	{
		if( null == self::$instance ) {
			self::$instance = new Heartbeat_News();
		}
	...
	function register_autoloader( $class ) 
	{
		...
		$file = 'class-heartbeat-news-' . implode( '-', $directories );
	...
	{
    	$event = Heartbeat_News_Posts_News::get_instance();
    }
    ...
    {
    	register_widget( 'Heartbeat_News_Widgets' );
    }

    function init_custom_admin_settings() 
    {
		$admin_settings = Heartbeat_News_Admin::get_instance();
    }

    function init_page_templates() 
    {
		$page_templates = Heartbeat_News_Pages_Listing::get_instance();
    }
}

$heartbeat_news = Heartbeat_News::get_instance();